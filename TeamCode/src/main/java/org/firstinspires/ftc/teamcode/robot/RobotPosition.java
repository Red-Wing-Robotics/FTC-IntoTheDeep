...
public class RobotPosition {
    ...
    static public final int ARM_HANG_SPECIMEN = (int)(40 * ARM_TICKS_PER_DEGREE); // TODO: find position
    ...
    static public final int VIPER_SLIDE_HANG_SPECIMEN = 0; // TODO: find position
