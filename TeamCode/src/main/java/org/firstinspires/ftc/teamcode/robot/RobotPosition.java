...
public class RobotPosition {
    ...
    static public final int VIPER_SLIDE_FULLY_EXTENDED = -1550;
    static public final int VIPER_SLIDE_EXPANSION_LIMIT = -1000;
    static public final int VIPER_SLIDE_ORIGIN = 0;
    static public final int VIPER_SLIDE_HANG_SPECIMEN = -500;
    static public final int VIPER_SLIDE_OFF_GROUND = -160;
