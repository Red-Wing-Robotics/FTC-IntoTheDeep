...
public class RobotPosition {
    ...
    static public final int ARM_SPECIMEN_AUTO = (int)(22 * ARM_TICKS_PER_DEGREE);
    static public final int ARM_SPECIMEN = (int)(23 * ARM_TICKS_PER_DEGREE);
    static public final int ARM_SUBMERSIBLE = (int)(31 * ARM_TICKS_PER_DEGREE);
