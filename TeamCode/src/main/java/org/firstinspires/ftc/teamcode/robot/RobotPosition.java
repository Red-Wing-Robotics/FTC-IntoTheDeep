...
public class RobotPosition {
    ...
    static public final double WRIST_IN = 0.05d;
    static public final double WRIST_SPECIMEN = 0.2d;
    ...
    static public final int ARM_HANG_SPECIMEN = (int)(52 * ARM_TICKS_PER_DEGREE); // TODO: find position
    ...
    static public final int VIPER_SLIDE_HANG_SPECIMEN = -1000; // TODO: find position
